...
import { useStableLoading } from '../../../hooks/useDebounce';
...
const AdminOverview = ({ onStatsUpdate }) => {
  ...
  const { isLoading: loading, setLoading } = useStableLoading(500);
  ...
  <Button onClick={fetchStats} variant="outline" disabled={!!refreshTimeout.current}>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button onClick={fetchStats} variant="outline" size="sm" disabled={!!refreshTimeout.current}>
                <Icon name="RefreshCw" size={16} className="mr-2" />
                Refresh
              </Button>
            </div>
